...
#---Instantiation of the Optical Elements
    ...
    if('DCM' in arElNames):
        ...
        if(_v.op_DCM_ac1 != 0): #Small rotation of DCM Crystal #1:
            ...
            tCr1 = matr_prod(rot[0], tCr1)
            sCr1 = matr_prod(rot[0], sCr1)
            nCr1 = matr_prod(rot[0], nCr1)
        ...
        if(_v.op_DCM_ac2 != 0): #Small rotation of DCM Crystal #2:
            ...
            tCr2 = matr_prod(rot[0], tCr2)
            sCr2 = matr_prod(rot[0], sCr2)
            nCr2 = matr_prod(rot[0], nCr2)
...
varParam = [
#---Data Folder
    ['fdir', 's', os.path.join(os.getcwd(), 'data_ESM'), 'folder (directory) name for reading-in input and saving output data files'],
...
#---Undulator
    ...
    #['und_len', 'f', 1.4, 'undulator length [m]'],
...
#---Calculation Types
    ...
    ['ss_ef', 'f', 2000., 'final photon energy [eV] for single-e spectrum vs photon energy calculation'],
    ...
    ['sm_ef', 'f', 2000., 'final photon energy [eV] for multi-e spectrum vs photon energy calculation'],
...
#---Add some constant "parameters" (not allowed to be varied) for the beamline
    #v.und_per = 0.057 #['und_per', 'f', 0.021, 'undulator period [m]'],
    #v.und_len = 1.4 #['und_len', 'f', 1.5, 'undulator length [m]'],
